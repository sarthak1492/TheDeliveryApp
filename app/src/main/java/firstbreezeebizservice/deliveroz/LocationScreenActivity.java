...
import firstbreezeebizservice.deliveroz.Listeners.RecyclerItemClickListener;
import firstbreezeebizservice.deliveroz.LocationServices.GPSTracker;
...
public class LocationScreenActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lblSelectLocaton = (TextView) findViewById(R.id.lblSelectLocation);

        txtNewLocation = (EditText) findViewById(R.id.txtNewLocation);



        mAutoCompleteAdapter = new PlaceAutoCompleteAdapter(this, R.layout.searchview_adapter,
        ...
        pbLocationFetch = (ProgressBar) findViewById(R.id.pbLocationFetch);

        pbLocationFetch.setVisibility(View.INVISIBLE);
        imgCurrentLocation.setVisibility(View.VISIBLE);


        btnApplyLocation = (Button) findViewById(R.id.btnApplyLocation);
