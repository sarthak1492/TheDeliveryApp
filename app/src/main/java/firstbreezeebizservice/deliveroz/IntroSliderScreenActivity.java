...
public class IntroSliderScreenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPagerSlider.setAdapter(myViewPagerAdapter);
        viewPagerSlider.addOnPageChangeListener(viewPagerPageChangeListener);

        btnSkip.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(IntroSliderScreenActivity.this, LoginScreenActivity.class);
